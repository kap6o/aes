...
public client_disconnect(id){
	g_fBuyTime[id] = 0.0
	g_players[id] = SUPER_NICHEGO // ñáðàñûâàåì âîçìîæíîñòè íà äèñêîííåêòå
}
...
public On_Player_Killed(id)
	g_players[id] = SUPER_NICHEGO // ñáðàñûâàåì âîçìîæíîñòè ïðè ñìåðòè
...
// ñáàðñûâàåì ìíîæèòåëü óðîíà ãðàíàòû
public deSetNade(id)
...
public pointBonus_GiveMegaDeagle(id){
	...
	cs_set_user_bpammo(id,CSW_DEAGLE,35) // êàêîé ìàêñèìóì?
